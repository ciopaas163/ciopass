...
@interface ConverseViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        cell =  (ConverseCell *)[[[NSBundle  mainBundle]  loadNibNamed:@"ConverseCell" owner:self options:nil]  lastObject];
    }
